	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			if ( $this->has_children && 0 === $depth ) {
				$item_output .= '<button class="ddl-switch"><i class="fa fa-solid fa-angle-down"></i></button>';
			}
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'bc-consulting' ) . '">' . esc_html__( 'Add a menu', 'bc-consulting' ) . '</a></li>';
			$fallback_output .= '</ul>';
