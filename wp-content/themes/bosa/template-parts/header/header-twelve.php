<header id="masthead" class="site-header header-twelve">
	<div class="top-header">
		<?php if( !get_theme_mod( 'disable_top_header_section', false ) ){ ?>
			<?php if( ( !get_theme_mod( 'disable_header_date', false ) || !get_theme_mod( 'disable_header_social_links', false ) && bosa_has_social() ) || has_nav_menu( 'menu-3') ){ ?>
				<div class="top-header-inner">
					<div class="container">
						<div class="row align-items-center">
							<div class="col-lg-8 d-none d-lg-block">
								<?php if( !get_theme_mod( 'disable_header_date', false ) ){ ?>
		...
		<?php if( !get_theme_mod( 'disable_mobile_top_header', false ) ){ ?>
			<?php if( !get_theme_mod( 'disable_header_date', false ) || get_theme_mod( 'header_advertisement_banner', '' ) != '' || ( !get_theme_mod( 'disable_header_social_links', false ) && bosa_has_social() ) || has_nav_menu( 'menu-3') || !get_theme_mod( 'disable_search_icon', false ) || is_active_sidebar( 'menu-sidebar' ) ){ ?>
			...
			<div class="row align-items-center">
				<div class="col-lg-10 d-none d-lg-block">
					<nav id="site-navigation" class="main-navigation d-none d-lg-flex">
						...
						<?php
							if( !get_theme_mod( 'disable_header_home_icon', false ) ){ ?>
